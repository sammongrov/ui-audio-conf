...
export default class AgoraAudioConf extends Component {
  constructor(props) {
    super(props);
    const { groupID, userID, instance } = props;
    this._mounted = false;
    ...
    this.state = {
      ...
      // isHeadset: false,
      isMute: true,
      isCameraTorch: false, // do i need it
      disableVideo: true,
      isHideButtons: false,
      visible: false,
      selectUid: undefined,
  ...
  componentDidMount() {
    ...
    const numberUID = parseInt(vcuserID, 16);
    ...
    RtcEngine.joinChannel(channelID, numberUID);
            ...
            <View style={[styles.bottomContainer]}>
              ...
              {!isSpeaker && (
                ...
                >
                  ...
                  >
                    <Text style={{ color: '#FFF', fontSize: 14 }}>Speakers disabled</Text>
                  </View>
                </View>
              )}
              <View style={{ flexDirection: 'column' }}>
                <View style={styles.bottomView}>
                  <OperateButton
                    style={!isSpeaker ? styles.iconBtnsOn : styles.iconBtns}
